...
線下訓練資料表 = 取得資料(線下訓練會員表, 線下訓練氣入追加表, 線下訓練入札表, 線下訓練落札表, 線下測試日序 - 7)
線下訓練資料表 = merge(線下訓練資料表, 線下氣入追加表[氣入追加日序 >= 線下測試日序 - 7 & 氣入追加日序 < 線下測試日序, .(氣入追加標籤 = 1), .(會員標識, 拍賣標識)], by = c("會員標識", "拍賣標識"), all.x = T)
線下訓練資料表 = merge(線下訓練資料表, 線下入札表[入札日序 >= 線下測試日序 - 7 & 入札日序 < 線下測試日序, .(入札標籤 = 1), .(會員標識, 拍賣標識)], by = c("會員標識", "拍賣標識"), all.x = T)
